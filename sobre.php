...
<body>
    ...
    <section class="hero-sobre text-center">
        <div class="container">
            ...
            <p class="lead">Revolucionando o acesso à saúde no Brasil desde 2023</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead">
                        O Conecta Saúde nasceu em 2023 da necessidade de simplificar o acesso à saúde no Brasil.
                    </p>
                    <p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="small mb-0">
                        &copy; 2023 Conecta Saúde. Todos os direitos reservados.<br>
