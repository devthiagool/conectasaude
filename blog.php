...
<body>
    ...
    <main class="container mt-4">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4">Blog CONECTASAUDE</h1>
        ...
        <div class="row">
            ...
            if ($has_db) {
                ...
                $artigos = [
                    ['id' => 1, 'titulo' => 'Importância do Check-up Anual', 'data' => '15/12/2023', 'resumo' => 'Saiba por que fazer check-up anual é essencial para prevenção.'],
                    ['id' => 2, 'titulo' => 'Alimentação Saudável no Inverno', 'data' => '10/12/2023', 'resumo' => 'Dicas para manter uma alimentação balanceada nos dias frios.'],
                    ['id' => 3, 'titulo' => 'Cuidados com a Saúde Mental', 'data' => '05/12/2023', 'resumo' => 'Como cuidar da saúde mental no dia a dia.'],
                ];
